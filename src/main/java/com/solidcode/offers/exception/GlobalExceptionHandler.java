...
import static com.solidcode.offers.exception.ErrorType.DUPLICATE_OFFER;
import static com.solidcode.offers.exception.ErrorType.INVALID_FIELD;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> duplicateUserExceptionHandling(Exception exception, WebRequest request) {
        ...
        return createSingleErrorListResponse(DUPLICATE_OFFER, exception, null);
    }
    ...
    public ResponseEntity<?> invalidParamExceptionHandling(OfferNotFoundException exception,
                                                           WebRequest request) {
